...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const { user, error: registerError } = await signUp(formData.email, formData.password);
        ...
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4 pb-32">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Đăng ký để bắt đầu quản lý tài chính</p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">Mật khẩu phải có ít nhất 8 ký tự</p>
                        </div>
                    ...
                    <div className="space-y-3">
                        <div className="text-center mb-2">
                            <p className="text-xs text-gray-500 dark:text-gray-400">
                                Chỉ cho phép đăng ký với: <strong>tranthanhloc130600@gmail.com</strong>
                            </p>
                        </div>
                        <Button
                            type="button"
