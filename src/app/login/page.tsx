...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (formData.email !== "tranthanhloc130600@gmail.com") {
        ...
        if (loginError) {
            ...
            // Sử dụng replace thay vì push để tránh reload
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="space-y-3">
                        {/* Error Alert */}
                        {error && <AnimatedAlert className="mb-4" title="Cảnh báo đăng nhập" description={error} />}
                        <Button
                            type="button"
                            variant="outline"
                            disabled={loading}
